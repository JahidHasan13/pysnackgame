...
class Game:
    ...
    def play_background_music(self):
        pygame.mixer.music.load("resources/BACKGROUNDUSIC.mp3")
    ...
    def show_game_over(self):
        ...
        self.screen.blit(line1, (100, 200))
        line2 = font.render(f" to play hit enter", True, (255, 255, 255))
        self.screen.blit(line2, (50, 150))
        pygame.display.flip()
